...
import pumpPublicRoutes from './routes/pump.public.routes.js';
import rewardRoutes from './routes/reward.routes.js';
import onboardingPublicRoutes from './routes/onboarding.public.routes.js';
...
app.use('/api/pumps', pumpPublicRoutes);
app.use('/api/rewards', rewardRoutes);
app.use('/api/onboarding', onboardingPublicRoutes);
